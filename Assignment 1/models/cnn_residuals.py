...
class CNNResidualsWrapper(BasicModelWrapper):
    ...
    def __init__(self, input_shape, kernel_sizes, filters_list, dense_units_list, 
        ...
        self.create_model(kernel_sizes, filters_list, dense_units_list, use_batch_norm, 
            dropout_percentage, use_max_pooling, activation)


    def create_model(self, kernel_sizes, filters_list, dense_units_list, use_batch_norm, 
        dropout_percentage, use_max_pooling, activation):
        
        input = keras.Input(self.input_shape)

        flattened_output = create_conv_residual_blocks(input, kernel_sizes, filters_list, use_batch_norm, use_max_pooling, 
            activation, self.weight_initializer)
