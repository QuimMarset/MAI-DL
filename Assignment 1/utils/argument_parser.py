...
def parse_input_arguments():
    ...
    parser.add_argument('--lr_decay', action='store_true', help='Use Exponential LR decay')
    ...
    parser.add_argument('--min_delta', type=float, help='Minimum change in the val loss to consider it an improvement', default=0)
