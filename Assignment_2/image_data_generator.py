...
def create_train_generator(dataframe, image_shape, batch_size, augmentation, mean_std, seed, class_mode='categorical'):
    if augmentation:
...
def create_val_generator(dataframe, image_shape, batch_size, mean_std, class_mode='categorical'):
    generator = create_image_data_generator(mean_std)
